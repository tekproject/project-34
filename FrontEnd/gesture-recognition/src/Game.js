        ...
        if (
            ...
            if (hand.length > 0) {
                ...
                if (
                    ...
                    estimatedGestures.gestures.map(p => p.estimatedGestures)
                    // const maxConfidence = confidence.indexOf(
                    //   Math.max.apply(undefined, confidence)
                    // )

                    // console.log('name', estimatedGestures.gestures[0].name)
                    //setting up game state, looking for thumb emoji
                    if (
                        estimatedGestures.gestures[0].name === "thumbs_up" &&
                        gamestate !== "played"
                    ) {
                        _signList()
                        gamestate = "played"
                        ...
                        // console.log(signList[currentSign].src)
                        ...
                        if (
                            ...
                            setSign(estimatedGestures.gestures[0].name)
                        }
